...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "chain_id", "address", name="uq_defi_factories_chain_address"
        ),
    )
    op.create_index(
        op.f("ix_defi_factories_chain_id"), "defi_factories", ["chain_id"], unique=False
    )
    op.create_index(
        op.f("ix_defi_factories_defi_version_id"),
        "defi_factories",
        ["defi_version_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["chain_id"], ["chains.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["defi_factory_id"], ["defi_factories.id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        op.f("ix_defi_pools_defi_factory_id"),
        "defi_pools",
        ["defi_factory_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_defi_factories_defi_version_id"), table_name="defi_factories"
    )
