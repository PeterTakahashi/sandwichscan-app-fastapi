...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "effective_gas_price_wei", sa.Numeric(precision=78, scale=0), nullable=True
        ),
    ...
    op.create_index(
        "idx_transactions_to", "transactions", ["chain_id", "to_address"], unique=False
    )
    op.create_index(
        op.f("ix_transactions_chain_id"), "transactions", ["chain_id"], unique=False
    )
    op.create_table(
        "swaps",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["defi_pool_id"], ["defi_pools.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        "idx_swaps_recipient", "swaps", ["chain_id", "recipient"], unique=False
    )
    op.create_index("idx_swaps_sender", "swaps", ["chain_id", "sender"], unique=False)
    op.create_index(
        op.f("ix_swaps_base_token_id"), "swaps", ["base_token_id"], unique=False
    )
    op.create_index(op.f("ix_swaps_chain_id"), "swaps", ["chain_id"], unique=False)
    op.create_index(
        op.f("ix_swaps_defi_pool_id"), "swaps", ["defi_pool_id"], unique=False
    )
    op.create_index(
        op.f("ix_swaps_transaction_id"), "swaps", ["transaction_id"], unique=False
    )
    op.create_table(
        "sandwich_attacks",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.Column("base_token_id", sa.Integer(), nullable=True),
        sa.Column(
            "victim_base_size_raw", sa.Numeric(precision=78, scale=0), nullable=True
        ),
        ...
        sa.Column(
            "gas_fee_wei_attacker", sa.Numeric(precision=78, scale=0), nullable=True
        ),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["back_attack_swap_id"], ["swaps.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["base_token_id"], ["tokens.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["chain_id"], ["chains.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["front_attack_swap_id"], ["swaps.id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "idx_sandwich_attacker", "sandwich_attacks", ["attacker_address"], unique=False
    )
    op.create_index(
        "idx_sandwich_chain", "sandwich_attacks", ["chain_id"], unique=False
    )
    op.create_index(
        "idx_sandwich_victim", "sandwich_attacks", ["victim_address"], unique=False
    )
    op.create_index(
        op.f("ix_sandwich_attacks_back_attack_swap_id"),
        "sandwich_attacks",
        ["back_attack_swap_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_sandwich_attacks_chain_id"),
        "sandwich_attacks",
        ["chain_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sandwich_attacks_front_attack_swap_id"),
        "sandwich_attacks",
        ["front_attack_swap_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sandwich_attacks_victim_swap_id"),
        "sandwich_attacks",
        ["victim_swap_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_sandwich_attacks_victim_swap_id"), table_name="sandwich_attacks"
    )
    op.drop_index(
        op.f("ix_sandwich_attacks_front_attack_swap_id"), table_name="sandwich_attacks"
    )
    ...
    op.drop_index(
        op.f("ix_sandwich_attacks_back_attack_swap_id"), table_name="sandwich_attacks"
    )
